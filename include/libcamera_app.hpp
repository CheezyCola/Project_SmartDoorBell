 ...
 * https://github.com/kbarni/LCCV/blob/main/include/libcamera_app.hpp
...
/**
 * @brief Base class for camera app\n
 * modified from https://github.com/kbarni/LCCV/blob/main/include/libcamera_app.hpp
 */
class LibcameraApp
{
public:
